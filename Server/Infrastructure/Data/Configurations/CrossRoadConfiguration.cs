...
public class CrossRoadConfiguration : IEntityTypeConfiguration<CrossRoad>
{
    public void Configure(EntityTypeBuilder<CrossRoad> builder)
    {
        builder.Property(o => o.Id).HasConversion(o => o.Value, value => new CrossRoadId(value));
